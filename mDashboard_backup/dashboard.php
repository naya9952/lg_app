...
$sql.=" from (";
$sql.=" select a.id, a.ime, a.cnt, a.eventtime, max(b.dtime) as historytime, max(b.id) as historyid";
$sql.=" from (select a.id, a.ime, count(c.ime) as cnt, max(c.dtime) as eventtime";
$sql.=" from lgu a";
